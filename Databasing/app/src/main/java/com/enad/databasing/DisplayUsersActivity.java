...
public class DisplayUsersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        shared = getSharedPreferences("Mon", Context.MODE_PRIVATE);
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            ivedit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    db.editUser(userid);
                    Intent create = new Intent(DisplayUsersActivity.this, EditUsersActivity.class);
                ...
                new AlertDialog.Builder(this)
                        ...
                        .setPositiveButton("YES", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                Toast.makeText(DisplayUsersActivity.this, "You have successfully logout", Toast.LENGTH_SHORT).show();
